...
counts_matrix <- read.table("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/jahu8701/MASTER_CLASS/data/salmon.merged.gene_counts.tsv", header=TRUE, row.names=1)
