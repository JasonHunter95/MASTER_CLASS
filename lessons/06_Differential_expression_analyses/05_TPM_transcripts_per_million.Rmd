...
TPM <- read.table("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/jahu8701/MASTER_CLASS/lessons/04_RNAseq_Dox/01_Mouse_dox_wt/dox_long/job_output/star_salmon/salmon.merged.gene_tpm.tsv", header=TRUE, row.names=1)
