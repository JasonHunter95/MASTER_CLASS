...
counts_matrix <- read.table("data/salmon.merged.gene_counts.tsv",
...
load("results/deseq_samples.RData", verbose = TRUE)
view(deseq_samples)
...
# Let's figure out each step
# - for loops are common practice so let's get to know them

for (i in 1:length(results_names)) {
  # grabbing the result name for i in for loop 
  # - will repeat for all result names
  ...
  # This will keep adding new results (as rows)
  # for each additional i in for loop
