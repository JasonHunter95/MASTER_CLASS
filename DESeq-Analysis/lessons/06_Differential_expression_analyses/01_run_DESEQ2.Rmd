...
load("lessons/06_Differential_expression_analyses/results/counts_results_DESEQ/DESEQ_results.rdata", verbose = TRUE)

# Note the write over for counts matrix
# and ordering of loading these two objects
...
# "time_point_48_vs_0"
# "time_point_96_vs_0"
# DESEQ found genes differential expression values
# for each time point relative to 0 time point.
